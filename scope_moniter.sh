...
cat arkadiyt/bounty-targets-data-main/data/bugcrowd_data.json | jq -r '.[].targets.in_scope[] | .target, .uri, .name' | grep "^https://github.com" | awk '{print $1}' | sed -e 's/\/\*$//' -e 's/\/$//' -e 's/#.*//' | cut -d"/" -f1-5 | unew -el -t -i -q data/Bugcrowd/bugcrowd_github_repo_inscope.txt
cat arkadiyt/bounty-targets-data-main/data/bugcrowd_data.json | jq -r '.[].targets.out_of_scope[] | .target, .uri, .name' | grep "^https://github.com" | awk '{print $1}' | sed -e 's/\/\*$//' -e 's/\/$//' -e 's/#.*//' | cut -d"/" -f1-5 | unew -el -t -i -q data/Bugcrowd/bugcrowd_github_repo_outofscope.txt
...
cat arkadiyt/bounty-targets-data-main/data/hackerone_data.json | jq -r '.[] | .targets.in_scope[] | select(.eligible_for_bounty==true) | .asset_identifier, .instruction' | grep "^https://github.com" | awk '{print $1}' | sed -e 's/\/\*$//' -e 's/\/$//' -e 's/#.*//' | cut -d"/" -f1-5 | unew -el -t -i -q data/Hackerone/hackerone_github_repo_inscope.txt
cat arkadiyt/bounty-targets-data-main/data/hackerone_data.json | jq -r '.[] | .targets.out_of_scope[] | select(.eligible_for_bounty==false) | .asset_identifier, .instruction' | grep "^https://github.com" | awk '{print $1}' | sed -e 's/\/\*$//' -e 's/\/$//' -e 's/#.*//' | cut -d"/" -f1-5 | unew -el -t -i -q data/Hackerone/hackerone_github_repo_outofscope.txt
...
cat arkadiyt/bounty-targets-data-main/data/intigriti_data.json | jq -r '.[] | .targets.in_scope[] | select(.impact!="No Bounty") | .endpoint' | grep "^https://github.com" | awk '{print $1}' | sed -e 's/\/\*$//' -e 's/\/$//' -e 's/#.*//' | cut -d"/" -f1-5 | unew -el -t -i -q data/Intigriti/intigriti_github_repo_inscope.txt
cat arkadiyt/bounty-targets-data-main/data/intigriti_data.json | jq -r '.[] | .targets.out_of_scope[] | select(.impact!="No Bounty") | .endpoint' | grep "^https://github.com" | awk '{print $1}' | sed -e 's/\/\*$//' -e 's/\/$//' -e 's/#.*//' | cut -d"/" -f1-5 | unew -el -t -i -q data/Intigriti/intigriti_github_repo_outofscope.txt
...
cat arkadiyt/bounty-targets-data-main/data/yeswehack_data.json | jq -r '.[].targets.in_scope[].target' | grep "^https://github.com" | awk '{print $1}' | sed -e 's/\/\*$//' -e 's/\/$//' -e 's/#.*//' | cut -d"/" -f1-5 | unew -el -t -i -q data/Yeswehack/yeswehack_github_repo_inscope.txt
cat arkadiyt/bounty-targets-data-main/data/yeswehack_data.json | jq -r '.[].targets.out_of_scope[].target' | grep "^https://github.com" | awk '{print $1}' | sed -e 's/\/\*$//' -e 's/\/$//' -e 's/#.*//' | cut -d"/" -f1-5 | unew -el -t -i -q data/Yeswehack/yeswehack_github_repo_outofscope.txt
...
# Github Repo
cat data/Bugcrowd/bugcrowd_github_repo_inscope.txt data/Hackerone/hackerone_github_repo_inscope.txt data/Intigriti/intigriti_github_repo_inscope.txt data/Yeswehack/yeswehack_github_repo_inscope.txt | unew -el -t -i -q data/GithubRepo/inscope_github_repo.txt
cat data/Bugcrowd/bugcrowd_github_repo_outofscope.txt data/Hackerone/hackerone_github_repo_outofscope.txt data/Intigriti/intigriti_github_repo_outofscope.txt data/Yeswehack/yeswehack_github_repo_outofscope.txt | unew -el -t -i -q data/GithubRepo/outofscope_github_repo.txt
